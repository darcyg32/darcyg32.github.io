...
const experiences = [
  {
    ...
    description: [
      "Led systems development, designing and implementing scalable solutions that streamlined operations and enhanced client experiences.",
      "Developed custom tools and integrations spanning backend infrastructure, CRMs, and third-party systems.",
      "Architected scalable solutions that integrated with existing business workflows and systems, focusing on system design and API development.",
      "Collaborated with cross-functional teams to deliver robust engineering solutions that drove operational efficiency.",
    ],
    skills: [
      "System Architecture",
      "Backend Development",
    ...
    achievements: ["Lead Role", "System Design", "Scalable Solutions"],
    icon: <FaRocket />,
    color: "#64ffda",
  },
  {
  ...
  },
  {
    ...
    company: "GuardianEyes - Security Camera System",
    location: "Adelaide, Australia",
    date: "Feb. 2024 - Jun. 2024",
    description: [
      "Built a real-time web application using HTML and Node.js for processing video feeds, extracting audio from video streams, and integrating third-party APIs for speech recognition.",
    ...
    achievements: ["2nd Place", "ThincLab", "Real-time Systems"],
    icon: <FaTrophy />,
    color: "#4fd1c7",
  },
];
